...
class AppealedCaseImporter extends Importer
{
    ...
    public static function getColumns(): array
    {
        return [
            ...
            ImportColumn::make('case_type')
                ->label('Case Type (REM, HOA or TPZ)')
                ->requiredMapping()
    ...
    public function resolveRecord(): ?AppealedCase
    {
        ...
        return AppealedCase::firstOrNew([
    ...
    {
        $body = 'Your appealed case data import has completed and ' . number_format($import->successful_rows) . ' ' . str('row')->plural($import->successful_rows) . ' imported.';
