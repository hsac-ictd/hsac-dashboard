    ...
    <div className="grid grid-cols-1 gap-2 px-0 lg:px-0 @xl/main:grid-cols-2 @5xl/main:grid-cols-4">
      ...
      >
        <CardHeader className="flex items-center gap-3 px-6 py-4 w-full">
          <div className="flex-shrink-0 rounded-full bg-[#000080]/60 p-6 flex items-center justify-center border-4 border-white/70 shadow-inner shadow-cyan-400/40">
            <PersonStanding className="text-cyan-300 w-10 h-10 drop-shadow-lg" />
          </div>

          <div className="flex-1 space-y-1">
            <CardDescription className="text-white font-semibold drop-shadow-md text-center text-[18px]">
