    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="container min-h-screen px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12">
            <div class="w-full lg:w-1/2">
                <p class="text-sm font-medium text-blue-500 dark:text-blue-400">429 error</p>
                <h1 class="mt-3 text-2xl font-semibold text-gray-800 dark:text-white md:text-3xl">Too Many Requests</h1>
                <p class="mt-4 text-gray-500 dark:text-gray-400">You're doing that too much. Try again later.</p>
